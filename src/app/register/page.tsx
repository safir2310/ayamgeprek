...
import { User, Lock, Mail, Phone, ArrowLeft, Eye, EyeOff, CheckCircle } from 'lucide-react'
        ...
        <div className="container mx-auto text-center">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-white/90 font-medium">
              Bergabung dan nikmati menu favoritmu
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <CardContent className="pt-4 px-4 sm:px-6">
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-12 h-12 text-base sm:text-lg bg-gray-50 border-gray-200 focus:border-orange-500 focus:ring-orange-500"
                      required
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-12 pr-12 h-12 text-base sm:text-lg bg-gray-50 border-gray-200 focus:border-orange-500 focus:ring-orange-500"
                      required
                      minLength={6}
                    />
                    <button
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full h-12 text-base sm:text-lg font-bold bg-gradient-to-r from-orange-500 to-yellow-500 hover:from-orange-600 hover:to-yellow-600 text-white shadow-lg"
                >
